...
import torch
import numpy as np
# from train_evalv2 import train, init_network
from importlib import import_module
import argparse

from trains.train_eval_adv import init_network, train
...
parser.add_argument('--epsilon', default=8 / 255, type=int)
...
parser.add_argument('--attack_iters', default=3, type=int, help='Attack iterations')
...
def doTrain():
    ...
    if model_name == 'FastText':
        ...
        from commons.utils import build_dataset, build_iterator, get_time_dif
